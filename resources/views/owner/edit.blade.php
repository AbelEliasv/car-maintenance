        ...
        <form method="POST" action="{{ route('owner.update',$owner) }}">
            ...
            <div class="mb-6">
                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    Nombre</label>
                <input type="text" id="text" name="name" value="{{ $owner->name}}"
            ...
            <div class="mb-6">
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    Apellidos</label>
                <input type="text" id="text" name="last_name" value="{{ $owner->last_name}}"
            ...
            <div class="mb-6">
                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    Correo</label>
                <input type="text" id="text" name="email" value="{{ $owner->email}}"
